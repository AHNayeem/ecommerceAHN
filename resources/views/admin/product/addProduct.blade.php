		...
		<div class="well">
			{!! Form::open([ 'route'=>'new-product', 'method'=> 'POST', 'class'=> 'form-horizontal','enctype'=>'multipart/form-data']) !!}
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control"  type="text" min="1" name="product_price" id="product_price">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="form-control"  type="number" min="1" name="product_quantity" id="product_quantity">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" name="product_short_description" id="product_short_description" rows="5" style="resize: vertical;"></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" name="category_long_description" id="category_long_description" rows="10" style="resize: vertical;"></textarea>
					</div>
				</div>
